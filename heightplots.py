...
heights = [325,350,400,500,600]
dts = 5*np.ones_like(heights)
#%%
nt_max = 580

times = np.zeros((len(heights),nt_max))
dt0 = 10
...
for j in range(len(heights)):
    ...
    filename = f'./newresultsberg/relaxation_lo_level3.0height{height}.0Gc1.0dt5.0psicrit1.0l3.0cellfactor1.0T10.0_damagemodelAT2higher__.bp'
