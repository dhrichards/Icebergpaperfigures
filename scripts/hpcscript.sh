...
cd /users/dancha/Icebergpaperfigures
...
mpirun --bind-to none -n $SLURM_NTASKS python3 scripts/iceshelf.py --lstar  0.008 --dtstar 10 --height 400 --nondim_length 10 --cellfactor 1.0 --lfactor 2 --seed_cracks 0 --strength 150
# mpirun --bind-to none -n $SLURM_NTASKS python3 scripts/degradationtest.py --lstar  0.001 --cellfactor 2.0
